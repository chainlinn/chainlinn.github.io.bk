...
[✅什么是buffer pool？]({{< ref "MySQL/✅什么是buffer pool？.md" >}})
...
![](/images/2023/1692360052478-7a123e12-d590-438f-9abd-c968f0b7b2bb.png)（图源自：[✅InnoDB的一次更新事务是怎么实现的？]({{< ref "MySQL/✅InnoDB的一次更新事务过程是怎么样的？.md" >}})）
