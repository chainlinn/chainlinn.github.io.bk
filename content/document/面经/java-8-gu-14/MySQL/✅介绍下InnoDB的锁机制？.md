...
[✅什么是排他锁和共享锁？]({{< ref "MySQL/✅什么是排他锁和共享锁？.md" >}})
...
[✅高并发情况下自增主键会不会重复，为什么？]({{< ref "MySQL/✅高并发情况下自增主键会不会重复，为什么？.md" >}})
...
[✅InnoDB中的表级锁、页级锁、行级锁？]({{< ref "MySQL/✅InnoDB中的表级锁、页级锁、行级锁？.md" >}})
