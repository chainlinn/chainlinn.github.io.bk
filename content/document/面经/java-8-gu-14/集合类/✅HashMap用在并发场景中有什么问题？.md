...
![](/images/2022/1668913906521-7dbb1c3c-ed05-4d16-a8ae-e85866115acb.png)
...
![](/images/2022/1668916452747-a9fda85d-73ce-4f68-a000-e61983cf04bd.png)

此时thread-2开始执行，当thread-2扩容完成后，结果如下：

![](/images/2022/1668916616017-f57c993c-352d-4da3-8668-25801c91fc58.png)

此时thread-1抢占到执行时间，开始执行：`e.next = newTable[i]; newTable[i] = e; e = next;`后，会变成如下样式：

![](/images/2022/1668916882051-03cebaa0-7f9a-446d-8ed0-b089dcdf58cc.png)

接着，进行下一次循环，继续执行`e.next = newTable[i]; newTable[i] = e; e = next;`，如下图所示

![](/images/2022/1668917031363-c9e2a3a8-8528-402c-94e2-25c5f34f2038.png)

因为此时e!=null，且e.next = null，开始执行最后一次循环，结果如下：

![](/images/2022/1668917228601-d50e0cff-5b7c-48b3-9c4d-74eabbb69ff8.png)
