---
title: "定时任务扫表的缺点有什么？"
date: 2026-03-22T00:56:24+08:00
draft: false
categories:
  - 分布式
---
...
[✅区分度不高的字段建索引一定没用吗？]({{< ref "MySQL/✅区分度不高的字段建索引一定没用吗？.md" >}})
...
[✅为啥不要在事务中做外部调用？]({{< ref "场景题/✅为啥不要在事务中做外部调用？.md" >}})



[✅基于Spring Event，实现同步转异步，解决定时任务扫表导致数据库连接池不够的问题]({{< ref "项目难点&亮点/✅基于Spring Event，实现同步转异步，解决定时任务扫表导致数据库连接池不够的问题.md" >}})
