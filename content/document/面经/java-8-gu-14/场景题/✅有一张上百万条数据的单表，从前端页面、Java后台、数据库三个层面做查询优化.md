...
[✅如何在 Java 中实现高效的异步编程？如何避免回调地狱？]({{< ref "Java并发/✅如何在 Java 中实现高效的异步编程？如何避免回调地狱？.md" >}})
...
[✅索引失效的问题是如何排查的，有哪些种情况？]({{< ref "场景题/✅索引失效的问题是如何排查的，有哪些种情况？.md" >}})
...
[✅设计索引的时候有哪些原则（考虑哪些因素）？]({{< ref "MySQL/✅设计索引的时候有哪些原则（考虑哪些因素）？.md" >}})
...
[✅什么是数据库范式，为什么要反范式？]({{< ref "MySQL/✅什么是数据库范式，为什么要反范式？.md" >}})
