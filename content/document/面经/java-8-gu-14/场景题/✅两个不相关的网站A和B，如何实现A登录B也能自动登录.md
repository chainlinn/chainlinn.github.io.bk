---
title: "两个不相关的网站A和B，如何实现A登录B也能自动登录"
...
[✅分布式系统，用户登录信息保存在服务器A上，服务器B如何获取到共享Session]({{< ref "场景题/✅分布式系统，用户登录信息保存在服务器A上，服务器B如何获取到共享Session.md" >}})
...
[✅什么是OAuth2？有什么用？]({{< ref "分布式/✅什么是OAuth2？有什么用？.md" >}})
