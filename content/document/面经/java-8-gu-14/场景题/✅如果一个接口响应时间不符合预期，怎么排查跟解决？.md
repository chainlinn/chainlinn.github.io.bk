...
[✅一次RPC请求，客户端显示超时，但是服务端不超时，可能是什么原因？]({{< ref "场景题/✅一次RPC请求，客户端显示超时，但是服务端不超时，可能是什么原因？.md" >}})
...
[✅如何实现应用中的链路追踪？]({{< ref "分布式/✅如何实现应用中的链路追踪？.md" >}})
...
[✅Arthas统计方法耗时的原理是什么？]({{< ref "线上问题排查/✅Arthas统计方法耗时的原理是什么？.md" >}})
...
| 网络慢 | 同机房策略、单元化架构 |
| GC频繁 | JVM调优、调整堆大小 |
| 慢SQL | [✅如何进行SQL调优？]({{< ref "MySQL/✅如何进行SQL调优？.md" >}})  |
| 表中数据量大 | 分库分表、 分布式数据库 |
| 查询慢 | 加缓存 |
| 缓存失效 | 优化过期时间和淘汰策略 |
| 外部服务慢 | 异步调用 |
