...
[✅有了synchronized为什么还需要volatile?]({{< ref "Java并发/✅有了synchronized为什么还需要volatile_.md" >}})
...
## CAS实现单例
[✅不使用synchronized和Lock如何设计一个线程安全的单例？]({{< ref "场景题/✅不使用synchronized和Lock如何设计一个线程安全的单例？.md" >}})
