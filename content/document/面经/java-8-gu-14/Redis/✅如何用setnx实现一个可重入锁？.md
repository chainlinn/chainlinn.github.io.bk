...
首先，我们需要有一个标识来识别出一个线程，这里可以是线程ID，分布式的traceId（[https://www.yuque.com/hollis666/ec96i7/nnl88aqknhx2v76c](https://www.yuque.com/hollis666/ec96i7/nnl88aqknhx2v76c) ），或者是一个唯一的业务ID都可以。
...
[✅为什么Lua脚本可以保证原子性？]({{< ref "Redis/✅为什么Lua脚本可以保证原子性？.md" >}})
