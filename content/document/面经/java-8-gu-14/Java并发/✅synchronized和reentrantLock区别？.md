...
+ **ReentrantLock可以实现公平锁和非公平锁**，而**synchronized只是非公平锁**。（[✅sychronized是非公平锁，那么是如何体现的？]({{< ref "Java并发/✅synchronized是非公平锁，那么是如何体现的？.md" >}}) ）
...
[✅为什么虚拟线程不能用synchronized？]({{< ref "Java并发/✅为什么虚拟线程不能用synchronized？.md" >}})
