...
![](/images/2023/1696139602112-c0b9e1dc-1e54-43b7-a5f8-bda51ba28b68.png)
...
[✅有了CAS为啥还需要volatile？]({{< ref "Java并发/✅有了CAS为啥还需要volatile？.md" >}})
...
![](/images/2024/1704529191910-44e2d93f-794a-455e-be4f-0943a7e49f3f.png)

**当持有锁的线程释放锁时，AQS会将等待队列中的第一个线程唤醒，并让其重新尝试获取锁。**

![](/images/2024/1704529305749-dc2c1532-0a87-46b5-9aa6-d21522be542e.png)
...
![](/images/2024/1704527607626-fcffec73-dfa7-47f3-bf82-99b16ef0688d.png)
...
![](/images/2022/1671360897218-54f84a55-c6ca-4276-96d5-78863803a6be.png)
...
[✅CountDownLatch、CyclicBarrier、Semaphore区别？]({{< ref "Java并发/✅CountDownLatch、CyclicBarrier、Semaphore区别？.md" >}})
...
[✅AQS的同步队列和条件队列原理？]({{< ref "Java并发/✅AQS的同步队列和条件队列原理？.md" >}})
...
[✅什么是AQS的独占模式和共享模式？]({{< ref "Java并发/✅什么是AQS的独占模式和共享模式？.md" >}})
