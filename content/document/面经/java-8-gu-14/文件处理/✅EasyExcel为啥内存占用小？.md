...
EasyExcel 之所以能在处理大型 Excel 文件时保持较低的内存占用，主要归功于其**SAX解析设计（逐行读取+事件机制）**和**磁盘缓存策略**。（本文主要介绍EasyExcel的文件读取占用内存小的原因，文件写入其实和POI的 SXSSFWorkbook  原理一样的。直接看[https://www.yuque.com/hollis666/ec96i7/ivczis4gyskog9q2](https://www.yuque.com/hollis666/ec96i7/ivczis4gyskog9q2) 就可以了）
...
[✅什么是POI，为什么它会导致内存溢出？]({{< ref "文件处理/✅什么是POI，为什么它会导致内存溢出？.md" >}})
