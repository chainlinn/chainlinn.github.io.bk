---
title: "1年经验，数字藏品&电商项目"
date: 2026-03-22T00:53:45+08:00
draft: false
categories:
  - 面经实战
---
...
[✅布隆过滤器无法删除的问题如何解决？]({{< ref "高性能/✅布隆过滤器无法删除的问题如何解决？.md" >}})
...
[🧣🧣🧣项目实战课介绍&老用户福利]({{< ref "📮📮📮必读📮📮📮/🧣🧣🧣项目实战课介绍&老用户福利.md" >}})
...
[✅基于状态机+乐观锁解决订单支付和关单的并发问题]({{< ref "项目难点&亮点/✅基于状态机+乐观锁解决订单支付和关单的并发问题.md" >}})
...
[✅用了一锁二查三更新，为啥还出现了重复数据？]({{< ref "场景题/✅用了一锁二查三更新，为啥还出现了重复数据？.md" >}})
...
[✅为什么Redis设计成单线程也能这么快？]({{< ref "Redis/✅为什么Redis设计成单线程也能这么快？.md" >}})
