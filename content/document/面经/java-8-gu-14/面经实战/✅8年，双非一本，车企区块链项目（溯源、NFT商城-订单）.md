---
title: "8年，双非一本，车企区块链项目（溯源、NFT商城-订单）"
date: 2026-03-22T00:53:43+08:00
draft: false
categories:
  - 面经实战
---
...
[✅xxl-job如何保证一任务只会触发一次？]({{< ref "定时任务/✅xxl-job如何保证一任务只会触发一次？.md" >}})
...
[✅库存扣减如何避免超卖和少卖？]({{< ref "场景题/✅库存扣减如何避免超卖和少卖？.md" >}})



其他的几个问题，很难通过八股来讲清楚，在[项目课](https://www.yuque.com/hollis666/ec96i7/dgolk0cckpb94sia)中有具体方案落地。
...
[✅秒杀场景下，怎么加库存？]({{< ref "场景题/✅秒杀场景下，怎么加库存？.md" >}})
...
[✅RocketMQ的事务消息是如何实现的？]({{< ref "RocketMQ/✅RocketMQ的事务消息是如何实现的？.md" >}})
...
[✅分布式锁有几种实现方式？]({{< ref "分布式/✅分布式锁有几种实现方式？.md" >}})
...
[✅什么是压测，怎么做压测？]({{< ref "高可用/✅什么是压测，怎么做压测？.md" >}})



[✅什么是限流？常见的限流算法有哪些？]({{< ref "高并发/✅什么是限流？常见的限流算法有哪些？.md" >}})
