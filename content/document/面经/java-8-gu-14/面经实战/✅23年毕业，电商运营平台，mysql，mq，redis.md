...
[✅SQL语句如何实现insertOrUpdate的功能？]({{< ref "MySQL/✅SQL语句如何实现insertOrUpdate的功能？.md" >}})
...
[✅rabbitMQ的整体架构是怎么样的？]({{< ref "RabbitMQ/✅rabbitMQ的整体架构是怎么样的？.md" >}})



[✅RabbitMQ是怎么做消息分发的？]({{< ref "RabbitMQ/✅RabbitMQ是怎么做消息分发的？.md" >}})



[✅什么是RabbitMQ的死信队列？]({{< ref "RabbitMQ/✅什么是RabbitMQ的死信队列？.md" >}})
...
[✅线程池的拒绝策略有哪些？]({{< ref "Java并发/✅线程池的拒绝策略有哪些？.md" >}})



[✅什么是线程池，如何实现的？]({{< ref "Java并发/✅什么是线程池，如何实现的？.md" >}})
...
[✅线程有几种状态，状态之间的流转是怎样的？]({{< ref "Java并发/✅线程有几种状态，状态之间的流转是怎样的？.md" >}})
...
[✅ForkJoinPool和ThreadPoolExecutor区别是什么？]({{< ref "Java并发/✅ForkJoinPool和ThreadPoolExecutor区别是什么？.md" >}})
...
[✅为什么不能用浮点数表示金额？]({{< ref "Java基础/✅为什么不能用浮点数表示金额？.md" >}})



[✅为什么不能用BigDecimal的equals方法做等值比较？]({{< ref "Java基础/✅为什么不能用BigDecimal的equals方法做等值比较？.md" >}})



[✅Java中有了基本类型为什么还需要包装类？]({{< ref "Java基础/✅Java中有了基本类型为什么还需要包装类？.md" >}})
...
[✅什么是缓存击穿、缓存穿透、缓存雪崩？]({{< ref "Redis/✅什么是缓存击穿、缓存穿透、缓存雪崩？.md" >}})
...
[✅如何用Zookeeper实现分布式锁？]({{< ref "Zookeeper/✅如何用Zookeeper实现分布式锁？.md" >}})
