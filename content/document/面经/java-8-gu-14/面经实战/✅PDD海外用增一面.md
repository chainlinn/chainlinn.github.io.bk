...
[✅RocketMQ的架构是怎么样的？](https://yuque.com/hollis666/ec96i7/fkx1hga7xlpbfbuv)

9. 如何用Redis统计亿级网站的uv

[✅除了做缓存，Redis还能用来干什么？]({{< ref "Redis/✅除了做缓存，Redis还能用来干什么？.md" >}})

10. 遇到过什么线上问题，如何处理

[✅RocketMQ消费堆积问题排查]({{< ref "线上问题排查/✅RocketMQ消费堆积问题排查.md" >}})
...
[✅Dubbo实现服务调用的过程是什么样的？]({{< ref "Dubbo/✅Dubbo的服务调用的过程是什么样的？.md" >}})
...
[✅JVM的运行时内存区域是怎样的？]({{< ref "JVM/✅JVM的运行时内存区域是怎样的？.md" >}})
