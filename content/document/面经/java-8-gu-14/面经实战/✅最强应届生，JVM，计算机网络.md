...
[✅MD5是加密算法吗？绝对安全吗？]({{< ref "网络安全/✅MD5是加密算法吗？绝对安全吗？.md" >}})



[✅对称加密和非对称加密有什么区别？]({{< ref "计算机网络/✅对称加密和非对称加密有什么区别？.md" >}})
...
[✅什么是UUID，能保证唯一吗？]({{< ref "Java基础/✅什么是UUID，能保证唯一吗？.md" >}})
...
[✅进程，线程和协程的区别]({{< ref "操作系统/✅进程，线程和协程的区别.md" >}})
...
[✅进程间通信方式有哪些？]({{< ref "操作系统/✅进程间通信方式有哪些？.md" >}})



[✅什么是全双工和半双工]({{< ref "操作系统/✅什么是全双工和半双工.md" >}})



[✅GPU和CPU区别？为什么挖矿、大模型都用GPU？]({{< ref "操作系统/✅GPU和CPU区别？为什么挖矿、大模型都用GPU？.md" >}})
...
[✅什么是TCP三次握手、四次挥手？]({{< ref "计算机网络/✅什么是TCP三次握手、四次挥手？.md" >}})



[✅为什么需要HTTP/2，他解决了什么问题？]({{< ref "计算机网络/✅为什么需要HTTP/2，他解决了什么问题？.md" >}})
...
[✅为什么初始标记和重新标记需要STW，而并发标记不需要？]({{< ref "JVM/✅为什么初始标记和重新标记需要STW，而并发标记不需要？.md" >}})



[✅什么是跨代引用，有什么问题？]({{< ref "JVM/✅什么是跨代引用，有什么问题？.md" >}})
