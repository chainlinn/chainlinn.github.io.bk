---
title: "基于Spring Event，实现同步转异步，解决定时任务扫表导致数据库连接池不够的问题"
date: 2026-03-22T01:02:58+08:00
draft: false
categories:
  - 项目难点&亮点
---
...
[✅定时任务扫表的方案有什么缺点？]({{< ref "定时任务/✅定时任务扫表的方案有什么缺点？.md" >}})



[✅分库分表后会带来哪些问题？]({{< ref "分库分表/✅分库分表后会带来哪些问题？.md" >}})



[✅在Spring中如何使用Spring Event做事件驱动]({{< ref "Spring/✅在Spring中如何使用Spring Event做事件驱动.md" >}})
